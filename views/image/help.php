<div class="container-fluid">
  ...
  <hr><h4>Methoden</h4>
  <div class="row">
    <div class="col-sm-1"><a href="<?php echo _URL_STUB_.'/image/first/help';?>">first</a></div>
    <div class="col-sm-8"><p>Erstes Bild einer Kamera in einem bestimmten Zeitabschnitt.</p></div>
  </div>
  <div class="row">
    <div class="col-sm-1"><a href="<?php echo _URL_STUB_.'/image/last/help';?>">last</a></div>
    <div class="col-sm-8"><p>Letztes Bild einer Kamera in einem bestimmten Zeitabschnitt.</p></div>
  </div>
  <div class="row">
    <div class="col-sm-1"><a href="<?php echo _URL_STUB_.'/image/live/help';?>">live</a></div>
    <div class="col-sm-8"><p>Live-Bild einer Kamera.</p></div>
  </div>
  <div class="row">
    <div class="col-sm-1"><a href="<?php echo _URL_STUB_.'/image/get/help';?>">get</a></div>
