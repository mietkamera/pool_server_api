<p class="lead">Gibt das letzte gespeicherte Bild auf einer Website aus.</p>
...
<div class="col-sm-10">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 col-lg-6"><p>Ausgabe zus&auml;tzlicher Informationen neben oder unter dem Bild-Widget. 
      M&ouml;gliche Werte sind 0 oder 1. Wird der Parameter nicht angegeben, setzt die API den Standardwert 1.</p></div>
  </div>
</div>
<hr />
<h4>Beispiel</h4>
