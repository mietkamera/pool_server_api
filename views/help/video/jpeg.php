...
<p>Wenn kein Bild vorhanden ist, wird ein leeres wei&szlig;es Bild in der angegebenen Gr&ouml;&szlig;e ausgegeben.</p>
<h4>URL-Syntax</h4>
...
<div class="col-sm-10">
  ...
  <div class="row">
   ...
   <div class="row">
    ...
    <div class="col-sm-8 col-lg-6"><p>Dieser optionale Parameter legt fest, ob das Bild &uuml;ber die
    gesamte Aufnahmezeit oder f&uuml;r eine bestimmte Kalenderwoche ausgeliefert wird. Wird der Parameter 
    nicht angegeben, wird das Vorschaubild f&uuml;r das Gesamtvideo ausgegeben.</p></div>
  </div>
   <div class="row">
...
<p>Der Aufruf liefert das Posterbild f&uuml;r das Video &uuml;ber die gesamte Aufnahmezeit in 768x432 Pixeln.</p>
<code><b>https://<?php echo $_SERVER['SERVER_NAME']._URL_STUB_.'/'.$this->module.'/'.$this->method.'/';?></b>df34e2/hd.kw.201804</code>
<p>Der Aufruf liefert das Posterbild f&uuml;r das Video der vierten Kalenderwoche in 2018 in 1920x1080 Pixeln.</p>
