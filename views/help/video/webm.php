  <p class="lead">Liefert die f&uuml;r eine Kamera erstellten Videos als WEBM-Videostream aus.</p>
  <h5>URL</h5>
  <code><span class="text-success">https://mobil.mietkamera.de/http-api/video/webm/</span><abbr title="Shorttag der Kamera"><b><em>st</em></b></abbr>/<abbr title="Parameter der Methode"><b><em>par</em></b></abbr></code>
  ...
  <hr><h5>Beispiel</h5>
  <code><b>https://mobil.mietkamera.de/http-api/video/webm/</b>df34e2/vgax.all</code>
  <p>Der Aufruf liefert die WEBM-Ressource über die gesamte Aufnahmezeit in 768x432 Pixeln.</p>
  <code><b>https://mobil.mietkamera.de/http-api/video/webm/</b>df34e2/hd.kw.201804</code>
  <p>Der Aufruf liefert die WEBM-Ressource der vierten Kalenderwoche in 2018 in 1920x1080 Pixeln.</p>
  <hr>
  <div class="row">
  	<div class="col-1"><a href="<?php echo _URL_STUB_.'/video/mp4/help';?>">mp4</a></div>
  	<div class="col-1"><a >webm</a></div>
