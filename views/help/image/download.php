<p class="lead">Download eines anhand des Datums genau spezifizierten Bildes mit den dazu 
                notwendigen Headern.</p>
<h4>URL-Syntax</h4>
...
<div class="row">
  ...
  </div>  <?php $this->render('help/div_parameter_size');?>
</div>
