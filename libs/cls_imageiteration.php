<?php
  ...
  **************************************************************************************************************** */
  class ImageIteration {
    public static $iterations = array ( '-'    => array(1,'alle 20 Sek','',18),
                                        '+'    => array(1,'alle 30 Sek','',28),
                                        '*'    => array(1,'jede Minute','',58),
                                        '*/2'  => array(2,'alle 2 Min','',90),
                                        '*/3'  => array(3,'alle 3 Min','',180),
                                        '*/4'  => array(4,'alle 4 Min','',220),
                                        '*/5'  => array(5,'alle 5 Min','',280),
                                        '*/10' => array(10,'alle 10 Min',' -filter:v "setpts=2.0*PTS"',580),
                                        '*/15' => array(15,'alle 15 Min',' -filter:v "setpts=3.0*PTS"',580),
                                        '*/20' => array(20,'alle 20 Min',' -filter:v "setpts=4.0*PTS"',580),
                                        '*/30' => array(30,'alle 30 Min',' -filter:v "setpts=6.0*PTS"',580),
